...
$lang = array_merge($lang, array(
	...
	'GRAPHIC_OPTIONS' => 'Grafické nastavenia',
	...
	'THANKS_FORUM_REPUT_VIEW_COLUMN' => 'Zobraziť hodnotenie fóra v stĺpci',
	'THANKS_FORUM_REPUT_VIEW_COLUMN_EXPLAIN' => 'Ak je povolené, hodnotenie fóra sa zobrazí v stĺpci v zozname fór. <br /> Poznámka: táto možnosť bude účinná len pre prosilver a ak je táto možnosť povolená.',
	...
	'THANKS_REPUT_GRAPHIC_EXPLAIN' => 'Ak je povolené, grafická hodnota sa zobrazí graficky pomocou obrázkov nižšie.',
	'THANKS_REPUT_HEIGHT' => 'Výška grafiky',
	'THANKS_REPUT_HEIGHT_EXPLAIN' => 'Zadajte výšku posuvníka pre hodnotenie v pixeloch. <br /> <strong> Pozor! Ak chcete zobraziť správne, mali by ste označiť výšku rovnú výške nasledujúceho obrázka! </strong>',
	'THANKS_REPUT_IMAGE' => 'Hlavný obrázok posuvníka',
	'THANKS_REPUT_IMAGE_DEFAULT' => '<strong>Ukážka grafiky</strong>',
	'THANKS_REPUT_IMAGE_DEFAULT_EXPLAIN' => 'Samotný obrázok a cesta k obrázku nájdete tu. Veľkosť obrázku je 15x15 pixelov. <br /> Môžete vytvoriť vlastné obrázky pre popredia a pozadie, môžete použiť súbor reput_star_.psd v priečinku contrib pre toto. <strong> Výška a šírka obrázka by mali byť rovnaké, aby sa zabezpečila správna konštrukcia grafickej stupnice.</strong>',
	'THANKS_REPUT_IMAGE_EXPLAIN' => 'Cesta - vo vzťahu ku koreňovej zložke phpBB - k obrázku v grafickej škále.',
	'THANKS_REPUT_IMAGE_NOEXIST' => 'Hlavný obrázok grafickej stupnice sa nenašiel.',
	'THANKS_REPUT_IMAGE_BACK' => 'Obrázok pozadia posuvníka',
	'THANKS_REPUT_IMAGE_BACK_EXPLAIN' => 'Cesta - vzhľadom ku koreňovej inštalačnej zložke phpBB - ku grafickému obrazu na pozadí.',
	'THANKS_REPUT_IMAGE_BACK_NOEXIST' => 'Obrázok pozadia pre grafiku sa nenašiel.',
	'THANKS_REPUT_LEVEL' => 'Počet obrázkov v grafickej škále',
	'THANKS_REPUT_LEVEL_EXPLAIN' => 'Maximálny počet obrázkov zodpovedajúci 100% hodnoty ratingovej stupnice v grafe.',
	...
	'THANKS_TOPIC_REPUT_VIEW_COLUMN' => 'Zobraziť hodnotenie témy v stĺpci',
	'THANKS_TOPIC_REPUT_VIEW_COLUMN_EXPLAIN' => 'Ak je táto funkcia zapnutá, hodnotenie témy sa zobrazí v stĺpci pri prezeraní fóra. <br /> Poznámka: táto možnosť bude účinná len pre prosilver a ak je táto možnosť povolená.',

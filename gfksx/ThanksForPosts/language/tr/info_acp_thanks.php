...
$lang = array_merge($lang, array(
	...
	'THANKS_NUMBER_EXPLAIN' => 'Bir profili görüntülerken görüntülenen maksimum teşekkür sayısı. <br /> <strong> Bu değer 250\'nin üzerine çıkarsa yavaşlamanın fark edileceğini unutmayın. </strong>',
	...
	'THANKS_NUMBER_POST_EXPLAIN' => 'Bir mesajı görüntülerken görüntülenen maksimum teşekkür sayısı. <br /> <strong> Bu değer 250\'nin üzerine çıkarsa yavaşlamanın fark edileceğini unutmayın. </strong>',
	...
	'ALLOW_THANKS_EMAIL_ON' => 'irisi mesajlarımdan birine teşekkür ettiyse bana e-posta ile bildir',
	'THANKS_POST_VIEW_GUESTS' => 'Tanımlanmayan kullanıcılara göster (misafir)',
	'THANKS_POST_VIEW_GUESTS_EXPLAIN' => 'Aktif ise, tanınan kullanıcılara (misafirler) değil, teşekkürler ve itibar gösterecek (etkinse).',
	'THANKS_POST_VIEW_ROBOTS' => 'Arama motorlarına göster (botlar))',
	'THANKS_POST_VIEW_ROBOTS_EXPLAIN' => 'Etkinleştirilirse, onaylar ve değerlendirme (etkinse) arama robotlarına gösterilir.'
		));
